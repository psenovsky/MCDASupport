# Check parameters of the function to find possible problems and stop
# execution of the run if problem is found
#
# parameters
...
Electre_2_paramCheck <- function(PM, w) {
  ...
  # general consistency checks, this is directly copied from Electre_2.
  # Intention is to let fail this function immediately instead of waiting
  # for it to fail when Electre_2 method is called in the sensitivity 
  # analysis run
