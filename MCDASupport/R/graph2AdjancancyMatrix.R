#' Transforms graph (a->b format) to adjacency matrix
#'
#' @description
#' Function transforms back graph specified by edges to adjacency matrix, with
#'  1 where edge exists and 0 where it does not.
#'
#' @param G Graph which should be transformed
#' @param alt alternatives names
#'
#' @return adjacency matrix for the graph with 0/1 representing graph.
#'
#' @author Pavel Šenovský \email{pavel.senovsky@vsb.cz}
#'
#' @keywords graph adjacency matrix
