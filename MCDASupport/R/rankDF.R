...
# ranklist - ranked list, each element in the list represents one rank. Each
# element in rank list can consist of multiple alternatives. This list needs
# to be flattened into dataframe in structure action and rank
